...
- **200**: Degraded (database OK, Square failed - optional service)
...
- **Database connection failed**: Check `DATABASE_URL` or `SGR_DATABASE_URL`
- **Square API failed**: Check Square credentials (optional, won't fail overall if database is OK)
