...
const connectionString = process.env.SGR_DATABASE_URL || process.env.DATABASE_URL;

if (!connectionString) {
  console.error('❌ Missing SGR_DATABASE_URL or DATABASE_URL environment variable.');
  process.exit(1);
}
