...
echo "🚀 Schema Deployment Script"
echo "=========================="
echo ""
echo "⚠️  WARNING: This will create/drop tables in your Neon database!"
echo ""
echo "📋 Pre-deployment Checklist:"
echo ""
echo "1. ✅ Database roles created (app_user, readonly_user)"
...
echo "   Check .env.local has correct SGR_DATABASE_URL"
echo ""
...
echo ""
echo "⚙️  Manual Fallback (only if migrations are not available):"
echo "1. Open Neon Dashboard → SQL Editor"
