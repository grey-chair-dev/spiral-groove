...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-brand-orange text-white border-2 border-brand-black shadow-retro hover:shadow-retro-hover hover:bg-brand-red hover:neon-glow-orange-strong rounded-full transition-all duration-300",
    secondary: "bg-brand-mustard text-brand-black border-2 border-brand-black shadow-retro hover:shadow-retro-hover hover:bg-brand-pink hover:neon-glow-pink rounded-full transition-all duration-300",
