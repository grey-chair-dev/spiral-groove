          ...
          <section className="space-y-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mb-6 text-sm text-slate-300">
                Please keep your receipt/order confirmation. Policies below are based on time after purchase.
              </p>

              <div className="grid gap-6 md:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                  <h4 className="text-base font-semibold text-white mb-2">Vintage Vinyl</h4>
                  <p className="text-sm text-slate-300">48 hours after purchase.</p>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                  ...
                  <p className="text-sm text-slate-300">$5 restocking fee on all new returns.</p>
                </div>
              </div>
            </div>
          </section>
