...
This directory contains unit tests for the Local Commerce Template application.

## Test Structure

- `lib/db/lookup-tables.test.ts` - Tests for Maker, Label, and Genre CRUD operations
- `app/api/staff/makers.test.ts` - Tests for the Makers API endpoints
